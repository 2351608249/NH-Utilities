...
import static com.xir.NHUtilities.common.api.enums.MetaTileEntityID.EGG_MACHINE_HV;
import static com.xir.NHUtilities.common.api.enums.MetaTileEntityID.EGG_MACHINE_IV;
import static com.xir.NHUtilities.common.api.enums.MetaTileEntityID.EGG_MACHINE_LV;
...
import static com.xir.NHUtilities.common.api.enums.MetaTileEntityID.EGG_MACHINE_MV;
...
import static com.xir.NHUtilities.common.api.enums.NHUItemList.Egg_Machine_HV;
import static com.xir.NHUtilities.common.api.enums.NHUItemList.Egg_Machine_IV;
import static com.xir.NHUtilities.common.api.enums.NHUItemList.Egg_Machine_LV;
...
import static com.xir.NHUtilities.common.api.enums.NHUItemList.Egg_Machine_MV;
...
public class MachineLoader {
    ...
    private static void initEggMachine() {
        // spotless:off
        registerMTE(Egg_Machine_LV,     new MTEMagicalEggMachine(EGG_MACHINE_LV.ID,     trans("nhu.eggMachine.tier.LV"), 1));
        registerMTE(Egg_Machine_MV,     new MTEMagicalEggMachine(EGG_MACHINE_MV.ID,     trans("nhu.eggMachine.tier.MV"), 2));
        registerMTE(Egg_Machine_HV,     new MTEMagicalEggMachine(EGG_MACHINE_HV.ID,     trans("nhu.eggMachine.tier.HV"), 3));
